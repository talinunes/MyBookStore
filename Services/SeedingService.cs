...
namespace MyBookStore.Services
{
    ...
    {
        private MyBookStoreContext _context;

        public SeedingService(MyBookStoreContext context)
        {
            _context = context;
        }
